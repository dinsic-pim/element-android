...
import fr.gouv.tchap.features.login.TchapLoginResetPasswordFragment
...
interface FragmentModule {
    ...
    @Binds
    @IntoMap
    @FragmentKey(TchapLoginResetPasswordFragment::class)
    fun bindTchapLoginResetPasswordFragment(fragment: TchapLoginResetPasswordFragment): Fragment
